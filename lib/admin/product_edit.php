...
$query_member = "SELECT * FROM tb_pd WHERE pd_id = $pd_id"  
              ...
              <div class="row">
                 ...
                 <div class="col-md-8">
                   <form action="product_db.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-sm-10">
                      <select class="form-control select2" name="ref_l_id" id="ref_l_id" required>
                        <option value="<?php echo $row['pd_id'];?>">-- <?php if ($row['pd_id']==1) {
                  ...
                  ภาพเก่า<br>
                        ...
                        <img src="../images/<?php echo $row['pd_img'];?>" width="150px">
                        <input type="hidden" name="pd_img2" value="<?php echo $row['pd_img'];?>">
                        <br><br>
