          ...
          <div class="col-md-6">
            <table id="example1" class="table table-bordered  table-hover table-striped">
              ...
              <tbody>
                ...
                <tr>
                  <td><?php echo @$l+=1; ?></td>
                  <td><img src="../images/<?php echo $row_member['mem_img']; ?>" width="100%"></td>
                  ...
                  <td><a href="member_db.php?member=del&&mem_id=<?php echo $row_member['mem_id']; ?>" class="del-btn btn btn-danger"><i class="fas fas fa-trash"></i> del</a></td>
